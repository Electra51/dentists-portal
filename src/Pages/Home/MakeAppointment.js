...
//   return (
//     <>
//       <section className="max-w-7xl mx-auto rounded-md mt-20 lg:mt-32 bg-gradient-to-r from-slate-700 to-slate-800 relative overflow-hidden">
//         {/* Background Pattern */}
...
//                 alt="doctor"
//                 className="-mt-32 w-full h-auto object-cover"
//               />
//             </div>
...
//                   className="bg-teal-500 hover:bg-teal-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 flex items-center gap-2">
